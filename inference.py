...
Original file is located at
    https://colab.research.google.com/drive/1YhnG1xC495PqbNw2AJJFe2FKLA6CNUT6
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Run inference on a multimodal model for diagnosing genetic diseases.')
    parser.add_argument('--csv_file', type=str, required=True, help='Path to the input CSV file with image paths and texts')
